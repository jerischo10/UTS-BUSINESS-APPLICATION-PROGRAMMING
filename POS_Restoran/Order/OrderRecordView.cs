...
namespace POS_Restoran
{
    public partial class OrderRecordView : Form
    {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            if (stat == "new")
            {
                _order.add_order(dateTimePickerTanggal.Value, total_harga, "Belum Tercetak");
                //_detail.add_order();
            ...
            {
                _order.edit_order(id_order, dateTimePickerTanggal.Value, total_harga, status_order);
